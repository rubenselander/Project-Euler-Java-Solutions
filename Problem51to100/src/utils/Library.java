...
public final class Library {
	 ...
	 * Returns floor(sqrt(x)), for x >= 0.
	 *
	 * @param x the non-negative long whose square root is to be computed
	 * @return the largest long y such that y * y <= x
	 * @throws IllegalArgumentException if x is negative
	 */
	 ...
	 * Returns floor(sqrt(x)), for x >= 0.
	 *
	 * @param x the non-negative BigInteger whose square root is to be computed
	 * @return the largest long y such that y * y <= x
	 * @throws IllegalArgumentException if x is negative
	 */
